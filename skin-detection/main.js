(function(doc, nav) {
  ...
  function initialize() {
    ...
    logOpponentContexts["i"] = doc
      .getElementById("log-opponent-i")
      .getContext("2d");
    logOpponentContexts["rg"] = doc
      .getElementById("log-opponent-rg")
      .getContext("2d");
    logOpponentContexts["by"] = doc
      .getElementById("log-opponent-by")
      .getContext("2d");
  ...
  function detectSkin(
    ...
    function skin(intensity, hue, saturation) {
      //            if (intensity <= 5) {
      return (
        (between(hue, 110, 150) && between(saturation, 20, 60)) ||
